...
<body class="bg-gray-100 flex flex-col items-center min-h-screen px-4">
    ...
    <div class="text-center mb-6 mt-8">
        ...
        <p class="text-lg text-gray-800">
            <strong>*DISCLAIMER: Information from this site is meant to only be used as reference.
                <br>Always make sure to notify the restaurant and your server about your food allergies.</strong>
        </p>
    </div>
